...
static void report_util_setting_string(uint8_t n) {
  ...
  switch (n) {
    ...
    case 13:
      ...
      break;
    case 19:
      printPgmString(PSTR("Softstart, milliseconds"));
      break;
    case 20:
    ...
    case 27:
      ...
      break;
    case 28:
      printPgmString(PSTR("Spindle freq. 0 to 15"));
      break;
    case 30:
    ...
    for (idx = 0; idx < N_AXIS; idx++) {
      switch (set_idx) {
        case 0:
          ...
          report_util_setting_string(val + idx);
          break;
        case 1:
...
void report_realtime_status() {
  ...
  if (lim_pin_state | ctrl_pin_state | prb_pin_state) {
    ...
    if (ctrl_pin_state) {
      ...
      if (bit_istrue(ctrl_pin_state, CONTROL_PIN_INDEX_FAULT)) {
        serial_write('F');  //Pauls added code
      }
    }
  }
#endif
